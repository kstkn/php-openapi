...
class FormatsContainer
{
     ...
     */
    public static function registerFormat($type, $format, $fqcn)
    {
     ...
     */
    public static function getFormat($type, $format)
    {
        return isset(self::$list[$type][$format]) ? self::$list[$type][$format] : null;
    }
}
